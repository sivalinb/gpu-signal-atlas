...
|---|---|---|
| Week 2: ingest a domain corpus | Reviewed NVIDIA Xid, DCGM, NVLink/NVSwitch, NCCL, GPU Operator, Fluent Bit, OpenTelemetry, and runbook records | Source allow-list, cleaner, fingerprints, freshness SLA, 27-record corpus |
...
| Week 4: create evaluation data | Versioned v2 has 100 owner-reviewed cases plus a 16-case post-change holdout; independent GPU-SME review is pending | JSONL, SHA-256 fingerprints, 50/30/15/5 primary split, preserved first-run holdout |
